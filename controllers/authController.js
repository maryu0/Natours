...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  await user.save({ validateBeforeSave: false }); // This line saves the user document to the database (in Mongoose), but with validation disabled.
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // WHY we did not use User.findByIdAndUpdate() method here? -> video 138(6:57)
